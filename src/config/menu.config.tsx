...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  },
  {
    ...
    {
      title: 'Support',
      icon: CircleQuestionMark, // Assurez-vous d'importer l'icône 'Briefcase' en haut depuis 'lucide-react'
      path: '#',
    },
    {
      title: 'Help Center',
      icon: LifeBuoyIcon, // Assurez-vous d'importer l'icône 'Briefcase' en haut depuis 'lucide-react'
      path: '#',
    },
  // {
...
export const MENU_MEGA_MOBILE: MenuConfig = [
  ...
  //               path: '/account/home/settings-enterprise',
  //             },
  //             { title: 'Plain', path: '/account/settings' },
  //             { title: 'Modal', path: '/account/home/settings-modal' },
  //           ],
  //         },
  //         {
